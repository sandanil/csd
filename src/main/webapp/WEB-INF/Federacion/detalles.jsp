...
<title>Detalles de Federaciones</title>
...
<h1 style="color: white;">Detalles de Federacion</h1>
<table
	...
	<input type="button" value="Listado de Federaciones" name="federacion" class="btn btn-primary" onclick="self.location.href = '/csd/federacion'" />
</body>
</html>